...
public class Puente extends VistaPrincipal {
	...
	public Puente() {
		...
		this.encolador = new Encolador(this.logica,this.cola,this.pilaUno,this.pilaDos,this.actualizador,this.lista,this.botonSeleccionarColor,this.panelSeleccionarColor,this.botonPedirColor,this.panelPedirColor,this.botonBorrarColor,this.panelBorrarColor);
